/*******************************************************************
 * File: Photoresistor V1
 *
 * (Constantly Emmitting Night-Light)
 *
 * Constant LED light, where brightness is the inverse of
...
void loop()
{
  ...
  Serial.print(ContrainedMaxLightLevel - lightLevel); // prints to the "Serial Monitor" button in top right
  analogWrite(ledPin, ContrainedMaxLightLevel - lightLevel);    // set the led level based on the input lightLevel.
}
/******************************************************************
